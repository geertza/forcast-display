...
function curSearch(){
    ...
    var queryURL = `https://api.openweathermap.org/data/2.5/weather?q=`+city+`&units=imperial&APPID=40c9d4a1f11de47af6e8bddf81304bce`;
        ...
        function forecastSearch(){
            ...
            .done(function(response) {
                ...
                function uvIndexSearch(){
                    ...
                    var queryURL = `https://api.openweathermap.org/data/2.5/uvi?appid=40c9d4a1f11de47af6e8bddf81304bce&lat=`+lat+`&lon=`+lon
                    $.ajax({url: queryURL, method: 'GET'})
                    .done(function(response) {
